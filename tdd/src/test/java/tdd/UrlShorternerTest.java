...
import tdd.UrlShorterner;
import tdd.CacheControllerFactory;
...
public class UrlShorternerTest {
	...
	private CacheControllerFactory controllerFactory;
	...
	public void setup() {
		...
		PowerMockito.when(CacheControllerFactory.getInstance()).thenReturn(this.controllerFactory);
